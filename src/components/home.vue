            ...
            <div class="content">
              <!-- 广告部分 -->
                 ...
                 <div v-if="data.moduleContent.banners" class="banner">
                    <div class="banner2">
                        <img v-if="data.moduleContent.banners.length===2" v-for="srcs in data.moduleContent.banners" :src="srcs.bannerImgSrc" alt="">
                    </div>
                    <ul class="banner5">
                      <li>
                          <img v-if="data.moduleContent.banners.length===5" v-for="srcs in data.moduleContent.banners" :src="srcs.bannerImgSrc" alt="">
                      </li>
                    </ul>
                ...
                <div v-if="data.moduleContent.products" class="product"> 
                    ...
                    <!-- 是否有等于22张图片产品轮播 -->
                        <div class=" module2 swiper-container" v-if=" data.moduleContent.products.length===22" >
                             <div class="swiper-wrapper">
                                  <div class="swiper-slide product22" v-for="pros in data.moduleContent.products" :key="data.id">
                        ...
                        <!-- 产品有3张图片 -->
                        <div class="product3" v-if=" data.moduleContent.products.length===3">
                          <ul>
...
<script>
  ...
  methods:{
     ...
     // 请求数据
     // https://m.wowdsgn.com/v2/page?pageId=1&tabId=10006&_=1542886907721
        axios.get("/v2/page?pageId=1&tabId=10006&_=1542886907721").then(res=>{
